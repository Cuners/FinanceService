...
namespace Finance.Application.UseCases.Accounts.DeleteAccount
{
    ...
    public class DeleteAccountUseCase
    {
        ...
        public DeleteAccountUseCase(IAccountRepository account, IUnitOfWork unitOfWork, ILogger<DeleteAccountUseCase> logger)
        {
            _account = account;
            _unitOfWork = unitOfWork;
            _logger= logger;
        }
        public async Task<DeleteAccountResponse> ExecuteAsync(DeleteAccountRequest request) 
        {
            try
            {
